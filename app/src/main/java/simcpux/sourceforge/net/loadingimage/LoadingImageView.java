...
public class LoadingImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(getDrawable() != null){
          ...
          //  Rect mRect = new Rect(0, 0, getWidth(), getHeight() * (100 - progress)/100);从下到上
          //  Rect mRect = new Rect(getWidth()* (/*100 - */progress)/100, 0,getWidth() ,getHeight() );从右到左
            Rect mRect = new Rect(getWidth()* (/*100 - */progress)/100, 0,getWidth() , getHeight() );
